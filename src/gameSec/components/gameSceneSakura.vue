<template>
  <div id="game-scene" :class="{'scene in' : showGame,
    ...
    <audio src="./assets/through.mp3" autoplay="autoplay"></audio>
    <div class="actor">
      <div class="user-index">
        <p>POINT  <span>{{POINT}}</span></p>
      </div>
      <img src="./assets/sakuraPer.png">
      <div>
...
<style scoped>
  ...
  #player {
    ...
    width: 100px;
    height: 100px;
    background-image: url(assets/sakuraPla.png);
  ...
  @keyframes myfirst
  {
    95% {background-image: url("assets/sakuraPla2.png")}
    100%  {background-image: url("assets/sakuraPla.png")}
  }
