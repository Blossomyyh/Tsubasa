...
<script>
  ...
  import GameScene from './gameSceneSakura'
  import SyaoranPath from './logic/sakuraPath.vue'
  export default {
    components: {
      StartScene,
      GameOverScene,
...
<style scoped>
  ...
  * {
  ...
  .scene {
    ...
    overflow: hidden;
    border-radius: 8px;
    /*border: 2px solid #c5615c;*/
    -webkit-transition: all .3s ease-out;
    background: black url("./assets/end.png");
